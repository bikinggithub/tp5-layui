<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\phpStudy\WWW\tp5\public/../application/admin\view\powermanage\rolelist.html";i:1524321411;s:64:"D:\phpStudy\WWW\tp5\public/../application/admin\view\layout.html";i:1525529271;s:70:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\menue.html";i:1525500366;s:68:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\nav.html";i:1525500301;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
  ...
  <tbody>
    ...
    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
	      ...
	      <td>
				<a style="cursor:pointer;" href="javascript:void(0);" onclick="checkAccessAction(<?php echo $vo['id']; ?>)">权限查看</a>&emsp;/&emsp;
	      		<a style="cursor:pointer;" href="javascript:void(0);" onclick="checkMembersAction(<?php echo $vo['id']; ?>)" >成员查看</a>
	      </td>
...
<script>
	...
	function addDataAction(){
		edituserbox = layer.open({
		  ...
		  title:'角色新增',
		  area: ['700px', '300px'], 
		  content: "<?php echo url('admin/Powermanage/roleadd'); ?>" //不想让iframe出现滚动条，可以content: ['http://sentsin.com', 'no']
		});
	}
