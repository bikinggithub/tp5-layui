<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\phpStudy\WWW\tp5\public/../application/admin\view\usermanage\add.html";i:1526705384;}*/ ?>
...
layui.use(['upload','layer','form'], function(){
  ...
  var uploadInst = upload.render({
    ...
    $.ajax({
        url:"<?php echo url('admin/Usermanage/add'); ?>",
        type:"POST",
