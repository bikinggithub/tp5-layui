<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\phpStudy\WWW\tp5\public/../application/admin\view\usermanage\userlist.html";i:1524582497;s:64:"D:\phpStudy\WWW\tp5\public/../application/admin\view\layout.html";i:1525500763;s:70:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\menue.html";i:1525500366;s:68:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\nav.html";i:1525500301;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
  ...
  <tbody>
    ...
    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
	    <tr>
	      <td>
	      	<div class="laytable-cell-checkbox">
	      		<input type="checkbox" lay-filter="itemChoose"  name="selectedidstr" lay-skin="primary" value="<?php echo $user['id']; ?>" />
	      	</div>
	      </td>
	      ...
	      <td>
	      	...
	      	<?php else: ?>
	      		<button class="layui-btn layui-btn-warm" onclick="editUser(<?php echo $user['id']; ?>)">修改</button>
	      		<button onclick="confirmdel(<?php echo $user['id']; ?>)" class="layui-btn layui-btn-danger">删除</button>
	      	<?php endif; ?>
...
<script>
	...
	function addUser(){
		edituserbox = layer.open({
		  ...
		  title:'用户新增',
		  area: ['700px', '500px'], 
		  content: "<?php echo url('admin/Usermanage/add'); ?>" //不想让iframe出现滚动条，可以content: ['http://sentsin.com', 'no']
		});
	}
